          ...
          <div className={styles.topSection}>
            ...
            <nav className={styles.nav}>
              <ul className={styles.navList}>
                ...
                <li>
                  <Link href="/category/headphones" className={styles.navLink}>
                    HEADPHONES
                  </Link>
                </li>
                <li>
                  <Link href="/category/speakers" className={styles.navLink}>
                    SPEAKERS
                  </Link>
                </li>
                <li>
                  <Link href="/category/earphones" className={styles.navLink}>
                    EARPHONES
                  </Link>
                </li>
              </ul>
